...
import com.quadrified.analytics.presentation.components.AnalyticsCard
...
fun AnalyticsDashboardScreenRoot(
    ...
    AnalyticsDashboardScreen(state = viewModel.state, onAction = { action ->
        when (action) {
...
private fun AnalyticsDashboardScreenPreview() {
    RuniqueTheme {
        AnalyticsDashboardScreen(state = AnalyticsDashboardState(
